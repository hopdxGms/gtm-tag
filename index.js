            ...
            for (const n of e)
                if (n.removedNodes.length > 0) {
                    switch (((language = document.getElementsByClassName("menu-title-underline")[0].innerHTML), language)) {
                        case "日本語":
                            label =
                                "私は、プライバシーポリシーに詳述されているお知らせやニュースレター、プロモーション、ベトナム航空および当社のパートナーによる当社の製品・サービスに関するオファーなどのマーケティングコミュニケーションに同意します。";
                            break;
                        case "English":
                            label =
                                'I accept Marketing communications as detailed in the <a href="https://www.vietnamairlines.com/nz/en/legal/privacy-policy">Privacy Policy</a> (such as notifications, newsletters, promotions, other offers in connection with our product and services from Vietnam Airlines and our partners.)';
                            break;
                        case "한국어":
                            label = "개인 정보 보호 정책에 자세히 설명된 마케팅 커뮤니케이션(예: 알림, 뉴스레터, 프로모션, 베트남 항공 및 협력사 제품과 서비스에 관한 기타 제안 등)을 수락합니다";
                            break;
